...
class TestRootMeanSquareDeviationCounter(unittest.TestCase):
    ...
    def test_compute_rmsd__parallel_lines__without_interpolation(self):
        ...
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(2), 2)
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(3), 2)
    ...
    def test_compute_rmsd__non_parallel_lines__without_interpolation(self):
        ...
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(2), expected_rmsd)
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(3), expected_rmsd)
    ...
    def test_compute_rmsd__two_coords__without_interpolation(self):
        ...
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(2), math.sqrt(2))
        self.assertAlmostEqual(rmsd_counter.compute_rmsd(3), math.sqrt(2))
